...
public:
	...
	static QString getCodeCommentNameById(CODE_ID id);
	...
	static QByteArray getQtCodecNameById(CODE_ID id);
	static bool tranStrToUNICODE(CODE_ID code, const char * pText, int length, QString & out, int* pOutErrorTextNum=nullptr);
	...
	static CODE_ID s_firstCheckCode;
	static CODE_ID s_secondCheckCode;
};
